...
if(isset($_POST['regid'])){
  ...
  $sql="SELECT name,dept from profile where regid='".$regid."'AND user_id='".$empid."'limit 1";
...
if ($result->num_rows > 0) {
  ...
  $sql="INSERT INTO remarks(regid,empid,remarks,vstatus,name,dept) VALUES('$regid','$empid','$remarks','$vstatus','$new','$new2')";
  $mysqli->query($sql);
}
  }
...
<tr>
<td colspan="4"><center><font size=4><b>REMARKS</b></font></center></td>
</tr>
<br>
<tr>
...
<td><input type="text" size=130 name="remarks">  </td>
</tr>
<tr>
...
<input id="s1" class="button" type="submit" onclick="return check(this.form)" value="VERIFIED">
