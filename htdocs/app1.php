...
$sql10 = "SELECT name,regid,empid,dept,remarks FROM remarks where vstatus='all ok' group by dept";
...
if ($result10->num_rows > 0) {
    ...
    while($row = $result10->fetch_assoc()) {
      ...
      $new4=$row['remarks'];
        ...
        echo "<center><p style='color:red;'><b> NAME: ".$new." <pre> DEPARTMENT: ".$new3."</pre><pre>  EMPLOYEE ID: ".$new1." </pre> <pre> REGISTRATION ID: ".$new2."</pre><pre>  REMARKS: ".$new4." </pre></b></p></center><br>";
    
 
 }
}
else echo "NO APPLICANTS";
