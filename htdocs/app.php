...
$sql10 = "SELECT name,regid,user_id,dept FROM profile";
...
if ($result10->num_rows > 0) {
       ...
       
  {
    ...
    if ($new3=='ATC' or $new3=='MT' or $new3=='FIRE' or $new3=='HK'){
        echo "<p style='color:red;'><b> NAME: ".$new." <pre> DEPARTMENT: ".$new3."</pre><pre> EMPLOYEE ID: ".$new1." </pre> <pre> REGISTRATION ID: ".$new2."</pre></b></p><br>";
    }
   if ($new3=='CNS'){
        echo "<p style='color:red;'><b> NAME: ".$new." <pre> DEPARTMENT: ".$new3."</pre><pre> EMPLOYEE ID: ".$new1." </pre> <pre> REGISTRATION ID: ".$new2."</pre></b></p><br>";
    }
   if ($new3=='ELECTRICAL' or $new3=='IT' or $new3=='CIVIL' ){
        echo "<p style='color:red;'><b> NAME: ".$new." <pre> DEPARTMENT: ".$new3."</pre><pre> EMPLOYEE ID: ".$new1." </pre> <pre> REGISTRATION ID: ".$new2."</pre></b></p><br>";
    }
   if ($new3=='GEN'){
        echo "<p style='color:red;'><b> NAME: ".$new." <pre> DEPARTMENT: ".$new3."</pre><pre> EMPLOYEE ID: ".$new1." </pre> <pre> REGISTRATION ID: ".$new2."</pre></b></p><br>";
